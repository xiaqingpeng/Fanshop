...
import 'package:LinJia/dao/login_dao.dart';
import 'package:LinJia/dao/login_reg_dao.dart';
...
import 'package:LinJia/page/reset_pwd_page.dart';
...
class _RegAndLoginState extends State<RegPageAndLoginPage> {
  ...
  void loadLoginByPass(String userName, String password) async {
    ...
    if (entity?.userModel != null) {
      print(entity!.userModel.toString() + 'entity!.userModel');
      saveUserInfo(entity.userModel);
    } else {
        print(entity!.msgModel.msg + 'entity!.msgModel.msg');
