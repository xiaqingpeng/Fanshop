...
class OrderCard extends StatelessWidget {
  ...
  OrderCard({required Key key, required this.orderModleDataList})
      : super(key: key);
  @override
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          String totalPriceStr =
                              (orderModleDataList[i].totalPrice / 100)
                                  .toStringAsFixed(2);
                          Map<String, String> p = {
                            "orderSn": orderModleDataList[i].orderSn,
                            "totalPrice": totalPriceStr
                          };
                          // Routes.instance.navigateToParams(
                          //     context, Routes.pay_page,
                          //     params: p);
                        },
                      ),
                    ),
