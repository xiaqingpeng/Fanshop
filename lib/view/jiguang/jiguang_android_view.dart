...
class JiGuangAndroidView extends StatefulWidget {
  const JiGuangAndroidView({Key? key}) : super(key: key);
  @override
  _JiGuangAndroidViewState createState() => _JiGuangAndroidViewState();
}

class _JiGuangAndroidViewState extends State<JiGuangAndroidView> {
